...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> bucketIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> bucketIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> bucketIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> bucketIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  QueryBuilder<Task, Task, QAfterSortBy> sortByBucketId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bucketId', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByBucketIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  QueryBuilder<Task, Task, QAfterSortBy> thenByBucketId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bucketId', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByBucketIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bucketId', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  QueryBuilder<Task, Task, QDistinct> distinctByBucketId() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, int, QQueryOperations> bucketIdProperty() {
    return QueryBuilder.apply(this, (query) {
